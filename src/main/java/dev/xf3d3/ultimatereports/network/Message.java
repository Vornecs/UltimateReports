...
public class Message {
    ...
    public enum Type {
        /**
         * Indicates the target server should pull and cache a new report from the database by ID.
         */
        REPORT_CREATE,
        /**
         * Indicates the target server should pull and cache new report data from the database by ID.
         */
        REPORT_UPDATE,
        /**
         * Indicates the target server should remove all data for a report by ID and remove it from the cache.
         */
        REPORT_DELETE,
        /**
